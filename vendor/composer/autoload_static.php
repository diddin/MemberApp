...
class ComposerStaticInit8d8862b8fbb9ed551434f3ea3da93b90
{
    ...
    public static $classMap = array (
        'AdapterProfileTest' => __DIR__ . '/../..' . '/tests/AdapterProfileTest.php',
        'DaoProfileTest' => __DIR__ . '/../..' . '/tests/DaoProfileTest.php',
        ...
        'app\\config\\singleton\\Database' => __DIR__ . '/../..' . '/app/config/Database.php',
        'app\\config\\singleton\\IDatabase' => __DIR__ . '/../..' . '/app/config/IDatabase.php',
        'app\\controller\\Route' => __DIR__ . '/../..' . '/app/Route.php',
        'app\\template\\builder\\HtmlPage' => __DIR__ . '/../..' . '/app/template/HtmlPage.php',
        'app\\template\\builder\\HtmlPageBuilder' => __DIR__ . '/../..' . '/app/template/HtmlPageBuilder.php',
        'app\\template\\builder\\PageBuilder' => __DIR__ . '/../..' . '/app/template/PageBuilder.php',
        'app\\template\\builder\\PageDirector' => __DIR__ . '/../..' . '/app/template/PageDirector.php',
        'app\\user\\adapter\\AdapterProfile' => __DIR__ . '/../..' . '/app/user/adapter/AdapterProfile.php',
        'app\\user\\adapter\\AdapterUser' => __DIR__ . '/../..' . '/app/user/adapter/AdapterUser.php',
        'app\\user\\adapter\\DaoProfile' => __DIR__ . '/../..' . '/app/user/adapter/DaoProfile.php',
        'app\\user\\adapter\\DaoUser' => __DIR__ . '/../..' . '/app/user/adapter/DaoUser.php',
        'app\\user\\adapter\\IAdapterUser' => __DIR__ . '/../..' . '/app/user/adapter/IAdapterUser.php',
        'app\\user\\adapter\\IDaoProfile' => __DIR__ . '/../..' . '/app/user/adapter/IDaoProfile.php',
        'app\\user\\adapter\\IDaoUser' => __DIR__ . '/../..' . '/app/user/adapter/IDaoUser.php',
        'app\\user\\factory\\FactoryPerson' => __DIR__ . '/../..' . '/app/user/factory/FactoryPerson.php',
        'app\\user\\factory\\FactoryPerson2' => __DIR__ . '/../..' . '/app/user/factory/FactoryPerson2.php',
        'app\\user\\factory\\IFactoryPerson' => __DIR__ . '/../..' . '/app/user/factory/IFactoryPerson.php',
        'app\\user\\factory\\IFactoryPerson2' => __DIR__ . '/../..' . '/app/user/factory/IFactoryPerson2.php',
        'app\\user\\factory\\IPerson' => __DIR__ . '/../..' . '/app/user/factory/IPerson.php',
        'app\\user\\factory\\Person' => __DIR__ . '/../..' . '/app/user/factory/Person.php',
        'app\\user\\factory\\Person2' => __DIR__ . '/../..' . '/app/user/factory/Person2.php',
        'app\\user\\proxy\\ProxyAdapterProfile' => __DIR__ . '/../..' . '/app/user/proxy/ProxyAdapterProfile.php',
        'app\\user\\proxy\\ProxyAdapterUser' => __DIR__ . '/../..' . '/app/user/proxy/ProxyAdapterUser.php',
        'menu\\About' => __DIR__ . '/../..' . '/app/menu/About.php',
        'menu\\Dashboard' => __DIR__ . '/../..' . '/app/menu/Dashboard.php',
        'menu\\Home' => __DIR__ . '/../..' . '/app/menu/Home.php',
        'menu\\Login' => __DIR__ . '/../..' . '/app/menu/Login.php',
        'menu\\Logout' => __DIR__ . '/../..' . '/app/menu/Logout.php',
        'menu\\Member' => __DIR__ . '/../..' . '/app/menu/Member.php',
        'menu\\Profile' => __DIR__ . '/../..' . '/app/menu/Profile.php',
        'menu\\ProfileEdit' => __DIR__ . '/../..' . '/app/menu/ProfileEdit.php',
        'menu\\Register' => __DIR__ . '/../..' . '/app/menu/Register.php',
        'menu\\RegisterProfile' => __DIR__ . '/../..' . '/app/menu/RegisterProfile.php',
        'tests\\AdapterUserTest' => __DIR__ . '/../..' . '/tests/AdapterUserTest.php',
        'tests\\DaoUserTest' => __DIR__ . '/../..' . '/tests/DaoUserTest.php',
        'tests\\DatabaseTest' => __DIR__ . '/../..' . '/tests/DatabaseTest.php',
        'tests\\FactoryPersonTest' => __DIR__ . '/../..' . '/tests/FactoryPersonTest.php',
        'tests\\PersonTest' => __DIR__ . '/../..' . '/tests/PersonTest.php',
        'user\\adapter\\IAdapterProfile' => __DIR__ . '/../..' . '/app/user/adapter/IAdapterProfile.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->fallbackDirsPsr4 = ComposerStaticInit8d8862b8fbb9ed551434f3ea3da93b90::$fallbackDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInit8d8862b8fbb9ed551434f3ea3da93b90::$prefixesPsr0;
            $loader->classMap = ComposerStaticInit8d8862b8fbb9ed551434f3ea3da93b90::$classMap;
